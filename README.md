...
def search_data():
    ...
    data_listbox = Listbox(search_window, height=15, width=60, bg="#FFFFFF")  # Set background color
...
regis_username = Label(root, text="New username 👤:", font=("Arial", 12), )  # Set background color
